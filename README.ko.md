...
- [상세 설명](#상세-설명)
  ...
  - [weeds-meeting](#weeds-meeting) - WEEDS 회의록 자동 작성
- [기여하기](#기여하기)
- [라이선스](#라이선스)
...
| [weeds-meeting](./plugins/weeds-meeting/) | WEEDS 회의록 자동 작성, 표준 형식으로 회의 내용 정리 | |
...
**WEEDS 회사의 표준 회의록 형식으로 회의 내용을 자동 작성합니다.**

회의 정보를 입력받아 회사 표준 형식에 맞춘 구조화된 회의록을 생성합니다. 비정형 텍스트(녹취록, 메모)도 분석하여 표준 형식으로 변환할 수 있습니다.
